...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1>
        <asp:Label ID="Label" runat="server" Text="Staff Management"></asp:Label>
    </h1>
    <div class="same-row">
    ...
    <div class="controllers">
        <asp:Button ID="btnAddStaff" class="button" runat="server" Text="Add a staff" />
        <asp:Button ID="btnDeleteStaff" class="button" runat="server" Text="Delete" />
        <asp:Button ID="btnFixStaff" class="button" runat="server" Text="Fix" />
        <asp:Button ID="btnStatisticStaff" class="button" runat="server" Text="Statistic"/>
    </div>
